...
INSERT INTO `activities` VALUES (1,'0',1),(2,'2',1),(3,'',1),(4,'',1);
...
INSERT INTO `employer` VALUES (1,'ООО \'СС\'','79221645476',1,NULL),(2,'123','79221645494',1,NULL);
...
CREATE TABLE `listofserviceemployer` (
  ...
  `employerID` int NOT NULL,
  `applicationsForJobPostings` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rekruter` VALUES (1,'Баоба',1,'не',1,1),(2,'Иван Иванов',2,'79221645404',1,2),(3,'не',1,'не',1,3);
...
INSERT INTO `users` VALUES (1,'2','1','не',3),(2,'password','login','1',3),(3,'123','321','не',3);
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'rekruters'
--

--
-- Dumping routines for database 'rekruters'
--
...
-- Dump completed on 2024-05-09 13:22:12
